                ...
                <form onSubmit={this.handleSubmit} className="col-md-10">
                    <div className="row group-section">
                        <div className="col-md-4">
                            ...
                            <div><span className="field-name">Salutation</span></div>
                            <div><span className="error-msg">{this.isInvalid('salutation') ? this.state.errors.salutation : ''}</span></div>
                        </div>
                        <div className="col-md-4">
                            <input type="text"
                            ...
                            <div><span className="field-name">First Name</span></div>
                            <div><span className="error-msg">{this.isInvalid('firstName') ? this.state.errors.firstName : ''}</span></div>
                        </div>
                        <div className="col-md-4">
                            <input type="text"
                            ...
                            <div><span className="field-name">Last Name</span></div>
                            <div><span className="error-msg">{this.isInvalid('lastName') ? this.state.errors.lastName : ''}</span></div>
                        </div>
                    </div>
                    <div className="row group-section">
                        <div className="col-md-4">
                            ...
                            <div><span className="error-msg">{this.isInvalid('title') ? this.state.errors.title : ''}</span></div>
                        </div>
                        <div className="col-md-4">
                            <input type="text"
                            ...
                            <div><span className="error-msg">{this.isInvalid('email') ? this.state.errors.email : ''}</span></div>
                        </div>
                    ...
                    <div className="row group-section">
                        ...
                        <div className="col-md-4">
                            ...
                            <div><span className="error-msg">{this.isInvalid('primary') ? this.state.errors.primary : ''}</span></div>
                        </div>
                        <div className="col-md-4"></div>
                    </div>
                    <div className="row group-section">
